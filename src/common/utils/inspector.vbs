POSTJSON "http://localhost:3000/api/inspectors?field=baseboard", WMI("select * from Win32_BaseBoard")
POSTJSON "http://localhost:3000/api/inspectors?field=bios", WMI("select * from Win32_BIOS")
POSTJSON "http://localhost:3000/api/inspectors?field=os", WMI("select * from Win32_OperatingSystem")
POSTJSON "http://localhost:3000/api/inspectors?field=cpu", WMI("select * from Win32_Processor")
POSTJSON "http://localhost:3000/api/inspectors?field=memorychip", WMI("select * from Win32_PhysicalMemory")
POSTJSON "http://localhost:3000/api/inspectors?field=diskdrive", WMI("select * from Win32_DiskDrive")
POSTJSON "http://localhost:3000/api/inspectors?field=netadapter", WMI("select * from Win32_NetworkAdapter")
POSTJSON "http://localhost:3000/api/inspectors?field=display", WMI("select * from Win32_DesktopMonitor")
POSTJSON "http://localhost:3000/api/inspectors?field=videoadapter", WMI("select * from Win32_VideoController")
POSTJSON "http://localhost:3000/api/inspectors?field=sound", WMI("select * from Win32_SoundDevice")
POSTJSON "http://localhost:3000/api/inspectors?field=useraccount", WMI("select * from Win32_UserAccount")
POSTJSON "http://localhost:3000/api/inspectors?field=useradmin", WMIUsersAdmin()
POSTJSON "http://localhost:3000/api/inspectors?field=share", WMI("select * from Win32_Share")
POSTJSON "http://localhost:3000/api/inspectors?field=printer", WMI("select * from Win32_Printer")
POSTJSON "http://localhost:3000/api/inspectors?field=product", WMI("select * from Win32_Product")
POSTJSON "http://localhost:3000/api/inspectors?field=fixupdate", WMI("SELECT * FROM Win32_QuickFixEngineering")
